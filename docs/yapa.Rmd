...
To evaluate this model, we simulated potential election results for 2016 based on 2012 state outcomes and 2016 state polls, and compared those to the election results.  94% of actual results fall within the 90% predictive intervals.  This model would have given Trump a ~30% chance of winning the election, and it would have handled the uncertainty in key battleground states better than many other poll aggregators and forecasters.  
