...
Biden is projected to win **between `r biden[1]` and `r biden[2]`** electoral college votes.  Trump is projected to win **between `r trump[1]` and `r trump[2]`** electoral college votes.  In `r dim(ec_sims)[1]` simulations of the presidential election from the perspective of `r format(Sys.Date(), format="%B %dth, %Y")`, Biden wins **`r paste0(round(mean(ec_sims[, 2] > ec_sims[, 1])*100), "%")`** and Trump wins **`r paste0(round(mean(ec_sims[, 1] > ec_sims[, 2])*100), "%")`**.
