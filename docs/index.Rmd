...
The plot below displays the distribution of potential electoral college results based on `r dim(ec_sims)[1]` simulations of the general election from the perspective of today.
...
The plot below displays the distribution of potential outcomes for the top two candidates in each state.  
