...
```{r stateresults}
biden_likely_winner <- p_biden$state[p_biden$p_biden >= 0.9]
biden_favored <- p_biden$state[p_biden$p_biden > 0.7 & p_biden$p_biden < 0.9]

trump_likely_winner <- p_biden$state[p_biden$p_biden < 0.1]
trump_favored <- p_biden$state[p_biden$p_biden > 0.1 & p_biden$p_biden < 0.3]

tossup <- p_biden$state[p_biden$p_biden >= 0.3 & p_biden$p_biden <= 0.7]
```
...
Note that uncertainties at this time are due to a) close races and/or b) few polls  As more polls become available and election day nears, the outcome of some states marked uncertain will become clearer.
